    ...
    <div className="bg-dark overflow-hidden">
      <div className="lg:px-31.75 px-5.25 lg:py-10 py-12">
        <motion.div variants={heroContainer} initial="hidden" animate="show">
          <motion.div
            variants={heroItem}
            className="text-[#7F8A95] lg:text-sm text-xs flex items-center justify-center lg:gap-4 font-fredoka leading-[120%]"
          >
            <p>Secure Storage</p>
            <BsDot size={30} />
          ...
          <motion.div
            variants={heroItem}
            className="text-center mx-auto mt-3 mb-5"
          >
          ...
          <motion.div
            variants={heroItem}
            className="lg:w-104.25 mx-auto text-center"
          >
            <p className="font-poppins lg:text-base text-sm text-[#B9C1C9] leading-[140%] tracking-[-5%]">
              Keep everything important safe and close. Whether it’s a quick
              note, a personal password, an important document, or even a video
              message
            </p>
          </motion.div>
        </motion.div>
      ...
      <div className="lg:h-187.5 h-112.5 w-full relative lg:bg-[url('/hero.png')] bg-[url('/hero_sm.png')] lg:bg-contain bg-cover bg-bottom bg-no-repeat">
        <motion.div variants={appLinksReveal} initial="hidden" animate="show">
          <AppLinks />
        </motion.div>
        <div className="lg:w-115.75 w-72.25 absolute bottom-0 translate-x-[65%] right-1/2">
          ...
          <motion.div
            ...
            initial="hidden"
            animate="show"
            className="lg:w-[79.4px] w-[49.6px] lg:h-[53.85px] h-[33.66px] absolute lg:bottom-25 bottom-18 px-1 bg-white rounded-xl drop-shadow-2xl flex items-center justify-center"
          >
