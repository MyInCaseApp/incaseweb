...
export default function Footer() {
  ...
  return (
    <footer className="lg:px-31.75 px-5.25 lg:py-10 py-12">
      ...
      <p className="font-poppins text-sm text-[#778492] text-center lg:w-93.5 mx-auto leading-[120%] tracking-[-5%]">
        Join thousands of Nigerians who trust InCase with their most important
        documents
      </p>
      <div className="lg:my-8 my-10">
        <AppLinks />
      </div>

      <div className="flex items-center flex-wrap justify-center lg:gap-x-6 gap-x-3.5 lg:gap-y-0 gap-y-5">
        {navLinks?.map((link) => (
          <NavLink
            key={link.id}
            to={link.link}
